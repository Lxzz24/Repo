...
三种结构
### 第一种：
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/Repo/images/SE0221.png)
```java
if(条件表达式){
	执行表达式
}
```
### 第二种：二选一
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/Repo/images/SE0222.png)
```java
if(条件表达式){
	执行表达式1
}else{
...
```
### 第三种：多选一
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/Repo/images/SE0223.png)
```java
if(条件表达式1){
	执行表达式1
}else if(条件表达式2){
...
```
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/Repo/images/SE0224.png)
> **使用说明：**
...
​![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/Repo/images/SE0225.png)
