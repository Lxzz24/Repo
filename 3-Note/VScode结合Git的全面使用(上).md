...
![image.png](images/VSGit03.png)

使用上其实大同小异，VScode 本身的功能加上插件辅助基本也可以实现差不多的效果。

## 认识界面

![image.png](images/VSGit04.png)
...
![image.png](images/VSGit06.png)

选中显示的文件可以对比前后修改的区别。

## commit 代码

![image.png](images/VSGit07.png)
