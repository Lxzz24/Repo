...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit01.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit02.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit03.png)

使用上其实大同小异，VScode 本身的功能加上插件辅助基本也可以实现差不多的效果。

## 认识界面

![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit04.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit05.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit06.png)

选中显示的文件可以对比前后修改的区别。

## commit 代码

![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit07.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit08.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit09.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit10.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit11.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit12.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit13.png)

在上面的输入框中输入分支的名字即可

![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit14.png)

我在上面创建了 release 分支，这样我就可以在 VScode 切换到 release 分支
我可以像之前那样对 release 分支进行各种修改 push 和 pull，这些修改就不会影响到 master 分支了。

![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit15.png)

第一次上传新的分支 VScode 会有弹窗提示。
上传成功之后也可以通过 github 来切换查看分支。

![image.png](https://cdn.jsdelivr.net/gh/Lxzz24/images/VSGit16.png)
